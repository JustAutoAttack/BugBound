...
Thank you for purchasing the Modular Blueprint Kit!
...
FBX/          - FBX files for Unity, Unreal Engine
...
and prototype_grid_floor.png). To switch colors:
  ...
  1. Rename the current default textures (e.g. add BLUE_ prefix)
  2. Copy the color you want and rename them to:
     - prototype_grid_main.png
     - prototype_grid_floor.png
  3. All pieces will update automatically
